...
VALID_DAYS=360
CA_KEY=server/ssl/out/ca.key
CA_CERT=server/ssl/out/ca.crt
CLIENT_KEY=server/ssl/out/client.key
CLIENT_CERT=server/ssl/out/client.crt
CLIENT_CSR=server/ssl/out/client.csr
CLIENT_P12=server/ssl/out/client.p12
SERVER_KEY=server/ssl/out/server.key
SERVER_CERT=server/ssl/out/server.crt
SERVER_CSR=server/ssl/out/server.csr
KEY_BITS=2048
